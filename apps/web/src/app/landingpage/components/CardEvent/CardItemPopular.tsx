...
const CardItemPopular = () => {
  return (
    <>
    <div className='md:w-[300px] w-[350px] shadow-2xl '>
      ...
      <div className='px-3 mt-4'>
        ...
        <div className='mt-3 flex justify-between flex-wrap'>
         <div className='grid grid-cols-2 gap-2'>
          <span className='text-[15px] font-light bg-slate-500 rounded-lg px-2'>Music</span>
          <span className='text-[15px] font-light bg-slate-500 rounded-lg px-2'>Food</span>
         </div>
        ...
        <text className='underline text-[15px] text-green-600'>View Deatails</text>
        </div>
      </div>
    </div>
   </>
